...
if __name__ == '__main__':
    ...
    trainset, validset = random_split(trainset, [int(len(trainset) * 0.7), len(trainset) - int(len(trainset) * 0.7)])
    ...
    cvGridSearch = GridSearchCV(net, params_options, cv=3, refit=True, name="cnn_3",
